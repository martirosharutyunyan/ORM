...
class ORM {
    constructor(TABLENAME, columns, params = { force: false, logging: false }, client) {
        ...
        try {
            ...
            for (let i = 0; i < array.length; i++) {
                const type = typeof array[i][1];
                const typeOfSQl = type === 'string' ? 'VARCHAR' : type === 'number' ? 'INTEGER' : 'BOOLEAN';
                arr = [...arr, { columnName: array[i][0], type: typeOfSQl }];
            }
            ;
            // @ts-ignore
            this.columns = arr;
...
exports.default = ORM;
//# sourceMappingURL=ORMForDevelopment.js.map